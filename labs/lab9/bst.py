...
class BinarySearchTree:
    ...
    def height(self) -> int:
        ...
        >>> bst.height()
        2
        >>> bst._right._right = BinarySearchTree(11)
        >>> bst.height()
        3
        """
        if self.is_empty():
    ...
    def rotate_right(self) -> None:
        """Ro
        tate the BST clockwise, i.e. make the left subtree the root.

        >>> bst = BinarySearchTree(7)
        >>> left = BinarySearchTree(3)
        >>> right = BinarySearchTree(11)
        >>> left._left = BinarySea'yrchTree(2)
        >>> left._right = BinarySearchTree(5)
        >>> bst._left = left
        >>> bst._right = right
        >>> print(bst)
