...
class Employee:
    ...
    pay_times: This times that employee be paid
    """
    id_: int
    name: str
    pay_times: int
    ...
    def total_pay(self) -> float:
        ...
        Precondition: The pay method is not called on the same employee more
        more than twice (include twice).
        ...
        300.0
        """
        return self.get_monthly_payment() * self.pay_times
