...
def test_total_payroll_mixed() -> None:
    my_corp = Company([SalariedEmployee(24, 'Gilbert the cat', 1200.0),
                       HourlyEmployee(25, 'Chairman Meow', 500.25, 1.0), SalariedEmployee(28, 'Gilbrt the cat', 2400.0)])
    my_corp.pay_all(date(2018, 6, 28))
    my_corp.pay_all(date(2018, 7, 28))
    my_corp.pay_all(date(2018, 10, 28))
    my_corp.pay_all(date(2018, 11, 28))
    assert my_corp.total_payroll() == 3201.0
