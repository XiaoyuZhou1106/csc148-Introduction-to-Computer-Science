...
class Customer:
    ...
    def make_call(self, call: Call) -> None:
        ...
        """
        for a in range(len(self._phone_lines)):
            if call.src_number == self._phone_lines[a].get_number():
                self._phone_lines[a].make_call(call)
    ...
    def receive_call(self, call: Call) -> None:
        ...
        for b in range(len(self._phone_lines)):
            if call.dst_number == self._phone_lines[b].get_number():
                self._phone_lines[b].receive_call(call)
